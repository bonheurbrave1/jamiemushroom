    ...
    <footer className="bg-green-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-serif font-bold mb-4">jamie's Farm</h3>
            <p className="mb-4">Growing the finest organic oyster mushrooms with sustainable practices since 2015.</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/products" className="hover:text-green-300 transition-colors">Our Products</a></li>
              <li><a href="/recipes" className="hover:text-green-300 transition-colors">Recipes</a></li>
          ...
          <div>
            ...
            <p className="mb-2">Kigali Rwanda, Gasabo,  95695</p>
            <p className="mb-2">Email: info@jamiefarm.com</p>
            <p>Phone: 250794082154</p>
          </div>
        </div>
        
        <div className="border-t border-green-800 mt-8 pt-8 text-center">
          <p>&copy; {new Date().getFullYear()} jamie's Farm. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
